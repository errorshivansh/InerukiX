...
from InerukiX.modules.utils.disable import disableable_dec
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/TeamInerukiX/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            strings["btn_channel"], url="https://t.me/InerukiXUpdates"
        ),
        InlineKeyboardButton(
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/InerukiXBOT?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
